...
function circularArrayRotation(a, k, queries) {
  ...
  let answer;
  if (Rotations === 0) {
    answer = loop(a, queries);
  } else {
    let array = a.slice(-Rotations);
    let rotatedArray = a.slice(0, -Rotations);
    let newArray = array.concat(rotatedArray);
    answer = loop(newArray, queries);
  }
  return answer;
}
