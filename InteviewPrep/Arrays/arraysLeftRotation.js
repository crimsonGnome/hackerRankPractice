...
//   let rotatedArray = a.slice(0, rotation);
//   let orginalArray = a.slice(rotation);
//   orginalArray = orginalArray.concat(rotatedArray);
//   return orginalArray;
// }
...
function rotLeft(a, d) {
  let rotation = d % a.length;
  return [...a.slice(rotation), ...a.slice(0, rotation)];
}
